...
object FileValidator {
    ...
    fun errorMessage(context: Context, error: Error, mimeType: String? = null): String {
        return when (error) {
            Error.UNKNOWN_TYPE -> context.getString(com.nabd.app.R.string.file_unknown_type)
            Error.UNSUPPORTED_TYPE -> context.getString(com.nabd.app.R.string.file_unsupported_type, mimeType ?: "?")
            Error.TOO_LARGE -> context.getString(com.nabd.app.R.string.file_too_large)
        }
    }
}
